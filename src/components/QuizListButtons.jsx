    ...
    return (
        <>
            <section className="container-top">
                <h2>Pregunta<span> {currentQuestion + 1} de {questions.length}</span></h2>
            </section>
            <div className="container-center">
                <div className='question'>{questions[currentQuestion].title}</div>
            </div>
            <div className="container-answers">
                {time > 3 ? <p style={{ color: 'green', fontWeight: "bold", fontSize:"1.1rem"  }}>Tiempo restante:{time}</p> : <p style={{ color: 'red', fontWeight: "bold", fontSize:"1.1rem"  }}>Tiempo restante:{time}</p>}
